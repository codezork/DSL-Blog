 ...
 */
package org.xtext.vaadin.example.geo.ide.contentassist.antlr;
...
import org.xtext.vaadin.example.geo.ide.contentassist.antlr.internal.InternalGeoDslParser;
import org.xtext.vaadin.example.geo.services.GeoDslGrammarAccess;

public class GeoDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(GeoDslGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GeoDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getGeoThemeAccess().getAlternatives(), "rule__GeoTheme__Alternatives");
			builder.put(grammarAccess.getGeoModelAccess().getGroup(), "rule__GeoModel__Group__0");
			builder.put(grammarAccess.getGeoModelAccess().getGroup_6(), "rule__GeoModel__Group_6__0");
			builder.put(grammarAccess.getGeoModelAccess().getGroup_7(), "rule__GeoModel__Group_7__0");
			builder.put(grammarAccess.getGeoModelAccess().getGroup_8_1(), "rule__GeoModel__Group_8_1__0");
			builder.put(grammarAccess.getGeoLayoutAccess().getGroup(), "rule__GeoLayout__Group__0");
			builder.put(grammarAccess.getGeoLayoutAccess().getGroup_3(), "rule__GeoLayout__Group_3__0");
			builder.put(grammarAccess.getGeoTabAccess().getGroup(), "rule__GeoTab__Group__0");
			builder.put(grammarAccess.getGeoTabAccess().getGroup_4(), "rule__GeoTab__Group_4__0");
			...
			builder.put(grammarAccess.getGeoModelAccess().getPackageNameAssignment_1(), "rule__GeoModel__PackageNameAssignment_1");
			builder.put(grammarAccess.getGeoModelAccess().getPortAssignment_3(), "rule__GeoModel__PortAssignment_3");
			builder.put(grammarAccess.getGeoModelAccess().getNameAssignment_5(), "rule__GeoModel__NameAssignment_5");
			builder.put(grammarAccess.getGeoModelAccess().getThemeAssignment_6_1(), "rule__GeoModel__ThemeAssignment_6_1");
			builder.put(grammarAccess.getGeoModelAccess().getHasStyleAssignment_7_0(), "rule__GeoModel__HasStyleAssignment_7_0");
			builder.put(grammarAccess.getGeoModelAccess().getStyleAssignment_7_1(), "rule__GeoModel__StyleAssignment_7_1");
			builder.put(grammarAccess.getGeoModelAccess().getPwaAssignment_8_0(), "rule__GeoModel__PwaAssignment_8_0");
			builder.put(grammarAccess.getGeoModelAccess().getHasLongNameAssignment_8_1_0(), "rule__GeoModel__HasLongNameAssignment_8_1_0");
			builder.put(grammarAccess.getGeoModelAccess().getLongNameAssignment_8_1_1(), "rule__GeoModel__LongNameAssignment_8_1_1");
			builder.put(grammarAccess.getGeoModelAccess().getLayoutAssignment_9(), "rule__GeoModel__LayoutAssignment_9");
			builder.put(grammarAccess.getGeoLayoutAccess().getNameAssignment_2(), "rule__GeoLayout__NameAssignment_2");
			builder.put(grammarAccess.getGeoLayoutAccess().getHasLogoAssignment_3_0(), "rule__GeoLayout__HasLogoAssignment_3_0");
			builder.put(grammarAccess.getGeoLayoutAccess().getLogoPathAssignment_3_1(), "rule__GeoLayout__LogoPathAssignment_3_1");
			builder.put(grammarAccess.getGeoLayoutAccess().getTabsAssignment_5(), "rule__GeoLayout__TabsAssignment_5");
			builder.put(grammarAccess.getGeoTabAccess().getNameAssignment_1(), "rule__GeoTab__NameAssignment_1");
			builder.put(grammarAccess.getGeoTabAccess().getIconNameAssignment_3(), "rule__GeoTab__IconNameAssignment_3");
			builder.put(grammarAccess.getGeoTabAccess().getHasTopologyAssignment_4_0(), "rule__GeoTab__HasTopologyAssignment_4_0");
			builder.put(grammarAccess.getGeoTabAccess().getTopologyAssignment_4_1(), "rule__GeoTab__TopologyAssignment_4_1");
			...
			builder.put(grammarAccess.getGeoModelAccess().getUnorderedGroup_8(), "rule__GeoModel__UnorderedGroup_8");
		}
	}
	...
	@Override
	protected InternalGeoDslParser createParser() {
		InternalGeoDslParser result = new InternalGeoDslParser(null);
