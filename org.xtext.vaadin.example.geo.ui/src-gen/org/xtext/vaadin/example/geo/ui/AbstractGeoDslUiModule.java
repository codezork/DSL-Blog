...
import org.xtext.vaadin.example.geo.ide.contentassist.antlr.GeoDslParser;
import org.xtext.vaadin.example.geo.ide.contentassist.antlr.PartialGeoDslContentAssistParser;
import org.xtext.vaadin.example.geo.ide.contentassist.antlr.internal.InternalGeoDslLexer;
import org.xtext.vaadin.example.geo.ui.contentassist.GeoDslProposalProvider;
import org.xtext.vaadin.example.geo.ui.editor.GeoDslEditor;
import org.xtext.vaadin.example.geo.ui.labeling.GeoDslDescriptionLabelProvider;
import org.xtext.vaadin.example.geo.ui.labeling.GeoDslLabelProvider;
import org.xtext.vaadin.example.geo.ui.outline.GeoDslOutlineTreeProvider;
import org.xtext.vaadin.example.geo.ui.quickfix.GeoDslQuickfixProvider;
import org.xtext.vaadin.example.geo.validation.GeoDslValidatorConfigurationBlock;

/**
 * Manual modifications go to {@link GeoDslUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractGeoDslUiModule extends DefaultXbaseWithAnnotationsUiModule {

	public AbstractGeoDslUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(org.xtext.vaadin.example.geo.parser.antlr.internal.InternalGeoDslLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return GeoDslParser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalGeoDslLexer.class).toProvider(LexerProvider.create(InternalGeoDslLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return GeoDslValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return GeoDslLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(GeoDslDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return GeoDslOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return GeoDslQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return GeoDslProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialGeoDslContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("GeoDsl Compare");
	}
