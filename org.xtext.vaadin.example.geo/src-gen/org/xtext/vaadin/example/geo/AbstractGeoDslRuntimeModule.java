...
import org.xtext.vaadin.example.geo.parser.antlr.GeoDslAntlrTokenFileProvider;
import org.xtext.vaadin.example.geo.parser.antlr.GeoDslParser;
import org.xtext.vaadin.example.geo.parser.antlr.internal.InternalGeoDslLexer;
import org.xtext.vaadin.example.geo.scoping.GeoDslScopeProvider;
import org.xtext.vaadin.example.geo.serializer.GeoDslSemanticSequencer;
import org.xtext.vaadin.example.geo.serializer.GeoDslSyntacticSequencer;
import org.xtext.vaadin.example.geo.services.GeoDslGrammarAccess;
import org.xtext.vaadin.example.geo.validation.GeoDslConfigurableIssueCodesProvider;
import org.xtext.vaadin.example.geo.validation.GeoDslValidator;

/**
 * Manual modifications go to {@link GeoDslRuntimeModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractGeoDslRuntimeModule extends DefaultXbaseWithAnnotationsRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/xtext/vaadin/example/geo/GeoDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.xtext.vaadin.example.geo.GeoDsl");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("geo");
	}
	...
	public Class<? extends IGrammarAccess> bindIGrammarAccess() {
		return GeoDslGrammarAccess.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISemanticSequencer> bindISemanticSequencer() {
		return GeoDslSemanticSequencer.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISyntacticSequencer> bindISyntacticSequencer() {
		return GeoDslSyntacticSequencer.class;
	}
	...
	public Class<? extends IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return GeoDslAntlrTokenFileProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Class<? extends Lexer> bindLexer() {
		return InternalGeoDslLexer.class;
	}
	...
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Provider<? extends InternalGeoDslLexer> provideInternalGeoDslLexer() {
		return LexerProvider.create(InternalGeoDslLexer.class);
	}
	...
	public Class<? extends XbaseConfigurableIssueCodes> bindXbaseConfigurableIssueCodes() {
		return GeoDslConfigurableIssueCodesProvider.class;
	}
