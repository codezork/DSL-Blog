...
public class GeoDslSyntacticSequencer extends AbstractSyntacticSequencer {

	protected GeoDslGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (GeoDslGrammarAccess) access;
