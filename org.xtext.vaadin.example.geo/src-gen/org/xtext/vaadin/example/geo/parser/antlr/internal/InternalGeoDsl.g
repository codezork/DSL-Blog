...
entryRuleGeoModel returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getGeoModelRule()); }
	iv_ruleGeoModel=ruleGeoModel
	{ $current=$iv_ruleGeoModel.current; }
	EOF;

// Rule GeoModel
ruleGeoModel returns [EObject current=null]
@init {
	enterRule();
}
@after {
				...
				{getUnorderedGroupHelper().canSelect(grammarAccess.getGeoModelAccess().getUnorderedGroup_8(), 1)}?=>(
					{
						getUnorderedGroupHelper().select(grammarAccess.getGeoModelAccess().getUnorderedGroup_8(), 1);
								...
								({true}?=>((
									(
										lv_hasLongName_12_0='description'
										{
...
entryRuleGeoLayout returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getGeoLayoutRule()); }
	iv_ruleGeoLayout=ruleGeoLayout
	{ $current=$iv_ruleGeoLayout.current; }
	EOF;

// Rule GeoLayout
ruleGeoLayout returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleGeoTab returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getGeoTabRule()); }
	iv_ruleGeoTab=ruleGeoTab
	{ $current=$iv_ruleGeoTab.current; }
	EOF;

// Rule GeoTab
ruleGeoTab returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Rule GeoTheme
ruleGeoTheme returns [Enumerator current=null]
@init {
	enterRule();
}
@after {
